...
public class TabStatus6 extends Fragment {
    ...
    public void getDataPemesanan() {
        try {
            ...
            mDatabase.child("pemesananKendaraan").child(status6).orderByChild("idRental").equalTo(idRental).addValueEventListener(new com.google.firebase.database.ValueEventListener() {
                @Override
