...
public class TabStatus6 extends Fragment {
    ...
    public void getDataPenyewaan() {
        try {
            ...
            mDatabase.child("penyewaanKendaraan").child(status6).orderByChild("idRental").equalTo(idRental).addValueEventListener(new com.google.firebase.database.ValueEventListener() {
                @Override
