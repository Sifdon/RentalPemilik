...
public class TabStatus4 extends Fragment {
    ...
    public void getDataPenyewaan() {
        try {
            ...
            mDatabase.child("penyewaanKendaraan").child(status4).orderByChild("idRental").equalTo(idRental).addValueEventListener(new com.google.firebase.database.ValueEventListener() {
                @Override
