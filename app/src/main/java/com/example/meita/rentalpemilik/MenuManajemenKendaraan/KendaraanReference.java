...
public class KendaraanReference implements Serializable {
    private String idKendaraan;
    private String kategoriKendaraan;
    private String idRental;

    public KendaraanReference() {}

    public KendaraanReference(String idKendaraan, String kategoriKendaraan, String idRental) {
