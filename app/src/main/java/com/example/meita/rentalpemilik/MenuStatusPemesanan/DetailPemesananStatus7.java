...
public class DetailPemesananStatus7 extends AppCompatActivity {
    ...
    Button buttonLihatBuktiPembayaran, btnLihatLokasiPenjemputan, btnLihatProfilPelanggan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLihatProfilPelanggan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DetailPemesananStatus7.this, LihatProfilPelanggan.class);
