...
public class DetailPemesananStatus6 extends AppCompatActivity {
    ...
    Button buttonLihatBuktiPembayaran, btnLihatBuktiPengembalianDana, btnLihatLokasiPenjemputan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLihatProfilPelanggan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DetailPemesananStatus6.this, LihatProfilPelanggan.class);
